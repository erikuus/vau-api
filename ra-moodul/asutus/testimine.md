...
## <mark style="color:green;">GET</mark> ra/company/test

```
{{apiBaseUrl}}/ra/company/test?token={{accessToken}}
```
...
GET 'https://www.ra.ee/vau/index.php/api/ra/company/test?token=bd266e2a556dc5331917d86252262c30' \
```
{% endcode %}
...
```json
{
    ...
    "errorCode": 500,
    "errorMessage": "CompanyController does not have a method \"test\"."
}
```
