...
## <mark style="color:green;">GET</mark> ra/meediateekOrder/test

```
{{apiBaseUrl}}/ra/meediateekOrder/test?token={{accessToken}}
```
...
GET 'https://www.ra.ee/vau/index.php/api/ra/meediateekOrder/test?token=bd266e2a556dc5331917d86252262c30' \
```
{% endcode %}
...
```json
{
    ...
    "errorCode": 500,
    "errorMessage": "MeediateekOrderController does not have a method \"test\"."
}
```
